...
class AtendimentoController extends AtendimentoModel
{
    public function CadastroAtendimento()
    {
        ...
        // var_dump($data_retorno, $nome_cliente, $telefone_cliente, $curso_negociado, $horario_inicio, $horario_fim, $dataAtual, $descricao, $cod_funcionario, $nome_funcionario, $tipo_atendimento);
       ...
       setcookie('lembrete', '', time() - 3600);
        ...
        $result = $atendimentoModel->cadastro($nome_cliente, $telefone_cliente, $curso_negociado, $horario_inicio, $horario_fim, $dataAtual, $descricao, $cod_funcionario, $nome_funcionario, $tipo_atendimento, $data_retorno);
